...
languageModel=/users/ljwinnie/Desktop/petrarch2/phrase_extractor/udpipe-1.0.0-bin/model/arabic-ud-1.2-160523.udpipe
...
#${udpipePath}/udpipe --tag --parse --outfile=${FILE}/$SFILENAME.conll.predpos.pred --input=conllu  $languageModel #${FILE}/$SFILENAME.conll # Creates $FILENAME.conll.predpos.pred
